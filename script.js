...
function openModal(service) {
    ...
    if (service === 'ugc') {
        html = `
            ...
            <video controls class="w-[180px] h-[320px] object-cover rounded-xl mx-auto mb-4">
...
function openVideoModal(videoSrc, title, description) {
    ...
    const html = `
        <div class="text-center">
            ...
            <video controls autoplay class="w-full max-w-[300px] h-[500px] object-contain rounded-xl  mx-auto mb-4">
